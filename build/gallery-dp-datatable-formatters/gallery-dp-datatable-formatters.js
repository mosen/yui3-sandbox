...
var DataTableFormatters = {
    ...
    /**
     * Get a formatter which generates a checkbox with the value being the clientId of the current row's model.
     * @param options
     */
    getCheckboxFormatter : function(options) {
        options.callback = options.callback || function() {};

        return function(o) {
            var CHECK_TEMPLATE = '<input type="checkbox" value="{clientId}" />';

            return Y.Lang.sub(CHECK_TEMPLATE, { clientId: o.model.get('clientId') });
        }
    }
